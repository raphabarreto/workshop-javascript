var WorkshopJavascript = WorkshopJavascript || {};


WorkshopJavascript.Estado = (function() {
	function Estado(){
...
WorkshopJavascript.Cidade = (function() {
...
$(function() {
	var estado = new WorkshopJavascript.Estado();
	estado.iniciar();

	var cidade = new WorkshopJavascript.Cidade(estado);
	cidade.iniciar();
});